...
export const compartments: Compartment[] = [
  ...
  },
  {
    ...
    alterations: [
      { id: 'normal', name: 'Normal', description: 'No significant abnormalities identified.', patternId: null },
      { id: 'acute-subchorionitis', name: 'Acute subchorionitis', description: 'Neutrophils in the subchorionic fibrin layer (MIR Stage 1). Select to specify MIR/FIR staging.\n\nMIR stages:\n- 1 = subchorionitis/chorionitis\n- 2 = chorioamnionitis\n- 3 = necrotizing chorioamnionitis (amniocyte necrosis)\n- Grade 2 = severe (confluent neutrophils or subchorionic microabscesses)\n\nFIR stages:\n- 1 = chorionic vasculitis and/or umbilical phlebitis\n- 2 = umbilical arteritis (+/- phlebitis/panvasculitis)\n- 3 = necrotizing funisitis\n- Grade 2 = severe (near-confluent intramural neutrophils with smooth-muscle attenuation)', patternId: 'AC' },
      { id: 'acute-chorionitis', name: 'Acute chorionitis', description: 'Neutrophils within the chorion (MIR Stage 1). Select to specify MIR/FIR staging.\n\nMIR stages:\n- 1 = subchorionitis/chorionitis\n- 2 = chorioamnionitis\n- 3 = necrotizing chorioamnionitis (amniocyte necrosis)\n- Grade 2 = severe (confluent neutrophils or subchorionic microabscesses)\n\nFIR stages:\n- 1 = chorionic vasculitis and/or umbilical phlebitis\n- 2 = umbilical arteritis (+/- phlebitis/panvasculitis)\n- 3 = necrotizing funisitis\n- Grade 2 = severe (near-confluent intramural neutrophils with smooth-muscle attenuation)', patternId: 'AC' },
      { id: 'acute-chorioamnionitis', name: 'Acute Chorioamnionitis', description: 'Neutrophils within the chorion and amnion (MIR Stage 2). Select to specify MIR/FIR staging.\n\nMIR stages:\n- 1 = subchorionitis/chorionitis\n- 2 = chorioamnionitis\n- 3 = necrotizing chorioamnionitis (amniocyte necrosis)\n- Grade 2 = severe (confluent neutrophils or subchorionic microabscesses)\n\nFIR stages:\n- 1 = chorionic vasculitis and/or umbilical phlebitis\n- 2 = umbilical arteritis (+/- phlebitis/panvasculitis)\n- 3 = necrotizing funisitis\n- Grade 2 = severe (near-confluent intramural neutrophils with smooth-muscle attenuation)', patternId: 'AC' },
