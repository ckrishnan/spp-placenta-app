...
export const compartments: Compartment[] = [
  {
    ...
    alterations: [
      ...
      { id: 'umbilical-cord-stricture', name: 'Umbilical cord stricture', description: 'A localized narrowing of the umbilical cord, a risk factor for FVM.', patternId: 'OTHER' },
      { id: 'thin-umbilical-cord', name: 'Thin umbilical cord', description: 'Umbilical cord diameter <8 mm at term, a risk factor for FVM.', patternId: 'OTHER' },
      { id: 'tethered-umbilical-cord', name: 'Tethered umbilical cord', description: 'Tight amniotic web restricting cord movement.', patternId: 'OTHER' },
  ...
  },
  {
    ...
    alterations: [
      ...
      { id: 'pigment-laden-macrophages', name: 'Pigment-laden macrophages', description: 'Presence of pigment-laden macrophages in the membranes or chorionic plate.', patternId: 'OTHER' },
